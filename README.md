...
👋 Hi, I’m **@CodePicsel**  
💻 I have 3+ years of experience in **app development** with a strong focus on **C#**, **Java**, and **JS**.  
🌱 Learning **advanced C#** and exploring **React + Expo** for modern web apps (including fiat & crypto exchange).  
🛠️ Worked on projects like **waste detection ML models**, and **cross-platform apps**.  
